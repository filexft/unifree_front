...
const SvgComponent = ({width,height},props) => (
  <svg
    ...
    {...props }
  >
    <rect width={6} height={1} x={47} y={29.5} fill="#9d2cf6" rx={3} ry={0.5}>
      <animate
